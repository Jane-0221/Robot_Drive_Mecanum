...
#define MECANUM_CURRENT_LIMIT 10.0f
#define MECANUM_ACCEL_LIMIT 10.0f
#define MECANUM_SPEED_LIMIT 20.0f

#define MECANUM_RAMP_INTERVAL_MS 1U
#define MECANUM_RAMP_LINEAR_ACCEL 1.3f
#define MECANUM_RAMP_LINEAR_DECEL 1.83f
#define MECANUM_RAMP_YAW_ACCEL 1.5f
#define MECANUM_RAMP_YAW_DECEL 1.83f
#define MECANUM_RAMP_LINEAR_LIMIT 2.3f
#define MECANUM_RAMP_YAW_LIMIT 3.5f
#define MECANUM_MOTOR_TX_INTERVAL_MS 5U
#define MECANUM_MOTOR_TX_COUNT 4U
#define MECANUM_MOTOR_RUNNING_PATTERN 2U
#define MECANUM_MOTOR_FEEDBACK_TIMEOUT_MS 500U
...
#define MECANUM_YAW_HOLD_KP 2.0f
#define MECANUM_YAW_HOLD_KI 0.02f
#define MECANUM_YAW_HOLD_KD 0.1f
#define MECANUM_YAW_HOLD_LIM_OUT 1.5f
#define MECANUM_YAW_HOLD_LIM_I_OUT 0.5f
#define MECANUM_TRANSLATION_ENABLE_THRESHOLD 0.02f
...
{
    RampGenerator_SetTarget(&mecanum_x_ramp, x);
    RampGenerator_SetTarget(&mecanum_y_ramp, y);
    RampGenerator_SetTarget(&mecanum_w_ramp, w);
                                                  ...
                                                  float *yaw_correction)
{
    ...
    *yaw_correction = 0.0f;
    ...
    if ((v_cmd > MECANUM_TRANSLATION_ENABLE_THRESHOLD) && (fabsf(*w_cmd) < MECANUM_YAW_CMD_DEADBAND))
    {
        ...
        *yaw_correction = pid_cal(&mecanum_yaw_hold_pid, *yaw_now, mecanum_yaw_target);
                                      ...
                                      uint32_t tick_ms)
{
    ...
    case 0U:
        ...
        {
            RobStride_Motor_Speed_control(&mecanum_motor_lf, MECANUM_CAN_HANDLE, cmd_lf, MECANUM_CURRENT_LIMIT);
    ...
    case 1U:
        ...
        {
            RobStride_Motor_Speed_control(&mecanum_motor_rf, MECANUM_CAN_HANDLE, cmd_rf, MECANUM_CURRENT_LIMIT);
    ...
    case 2U:
        ...
        {
            RobStride_Motor_Speed_control(&mecanum_motor_rb, MECANUM_CAN_HANDLE, cmd_rb, MECANUM_CURRENT_LIMIT);
    ...
    default:
        ...
        {
            RobStride_Motor_Speed_control(&mecanum_motor_lb, MECANUM_CAN_HANDLE, cmd_lb, MECANUM_CURRENT_LIMIT);
...
void Mecanum_Wheel_Init(void)
{
    ...
    mecanum_yaw_target = IMU_data.AHRS.yaw_rad_cnt;
    mecanum_yaw_lock_valid = 1U;
    Mecanum_Wheel_ResetYawPid();
...
void Mecanum_Wheel_Update(void)
{
    ...
    Mecanum_Wheel_ApplyStraightCorrection(x_cmd, y_cmd, &w_cmd, &yaw_now, &yaw_correction);
